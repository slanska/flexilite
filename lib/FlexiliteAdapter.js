...
var Driver = (function () {
     ...
     */
    Driver.prototype.buildObjectID = function (objectID, hostID) {
        if (hostID === void 0) { hostID = null; }
        //
        if (!hostID)
            hostID = objectID;
