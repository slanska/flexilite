...
var Driver = (function () {
     ...
     */
    Driver.prototype.processPropertyForSave = function (propInfo, schemaProps, nonSchemaProps) {
        var self = this;
        // Make sure that property is registered as class
    ...
    Driver.prototype.saveObject = function (table, data, objectID, hostID) {
        ...
        nonSchemaProps.forEach(function (item, idx, arr) {
            self.execSQL("insert or replace into [.values] (ObjectID, ClassID, PropertyID, PropIndex,\n                [Value], [ctlv]) values (?, ?, ?, ?, ?, ?)", item.objectID, item.classDef.ClassID, item.propID, item.propIndex, item.value, 0);
    ...
    Driver.prototype.isSql = function () {
        return true;
    };
    /*
