        ...
        Sync(function () {
            try {
                ...
                // Class not found. Insert new record
                {
                    ...
                    var rslt = insClsStmt.run.sync(insClsStmt, [opts.table, true, this.getViewName(opts.table)]);
                ...
                viewSQL += this.generateTriggerBegin(classDef.DBViewName, 'insert', 'whenNull', 'when new.[ObjectID] is null or new.[HostID] is null');
                ...
                viewSQL += this.generateTriggerBegin(classDef.DBViewName, 'insert', 'whenNotNull', 'when not (new.[ObjectID] is null or new.[HostID] is null)');
