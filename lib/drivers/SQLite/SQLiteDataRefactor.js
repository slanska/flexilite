...
(function (factory) {
    ...
    var SQLiteDataRefactor = (function () {
        function SQLiteDataRefactor(DB, className, classID) {
            this.DB = DB;
            this.className = className;
            this.classID = classID;
            this._lastActionReport = '';
            if (className)
                this.classDef = this.getClassDefByName(className);
            else if (classID)
                this.classDef = this.getClassDefByID(classID);
        }
        Object.defineProperty(SQLiteDataRefactor.prototype, "ClassID", {
            get: function () {
                return this.classDef.ClassID;
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(SQLiteDataRefactor.prototype, "ClassDefinition", {
            get: function () {
                return this.classDef.Data;
            },
            enumerable: true,
            configurable: true
        });
        ...
        SQLiteDataRefactor.prototype.generateClassAndSchemaDefForSync = function (model) {
            ...
            // TODO 
            return { Class: this.classDef, Schema: schemaData };
        };
