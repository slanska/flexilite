...
(function (factory) {
    ...
    var SQLiteDataRefactor = (function () {
        ...
        SQLiteDataRefactor.prototype.doGenerateView = function (classDef) {
        };
        /*
        ...
        SQLiteDataRefactor.prototype.generateClassAndSchemaDefForSync = function (model) {
            ...
            for (var idx = 0; idx < cols.length; idx++) {
                var propID = vars.columnAssignments[cols[idx]].propID;
                vars.classDef[cols[idx]] = propID;
                if (propID) {
                    var ch_offset = cols[idx].charCodeAt(0) - 'A'.charCodeAt(0);
