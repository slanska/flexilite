...
CREATE TABLE IF NOT EXISTS [.classes] (
  ...
  [NameID]         TEXT(64) NOT NULL CONSTRAINT [fkClassesNameID]
                                         REFERENCES [.names] ([NameID]) ON DELETE RESTRICT ON UPDATE RESTRICT,
  [ViewOutdated] BOOL NOT NULL DEFAULT 0,

  /*
  Name ID of base schema used for the class. The most version of base schema (where Variation is null) is used
  for new class items
  */
