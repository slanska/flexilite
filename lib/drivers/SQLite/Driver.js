...
(function (factory) {
    if (typeof module === 'object' && typeof module.exports === 'object') {
        ...
        define(["require", "exports", "lodash", "sqlite3", 'path', 'object-hash', "../../misc/schemaConverter"], factory);
    }
            ...
            var Driver = (function () {
                ...
                Driver.prototype.saveObject = function (table, data, objectID, hostID) {
                    ...
                    nonSchemaProps.forEach(function (item, idx, arr) {
                        self.execSQL("insert or replace into [.values_view] (ObjectID, ClassID, PropertyID, PropIndex,\n                [Value], [ctlv]) values (?, ?, ?, ?, ?, ?, ?)", item.ObjectID, item.CollectionID, item.PropertyID, item.PropIndex, item.Value, item.ctlv);
