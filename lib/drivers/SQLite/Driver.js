...
var SchemaConverter = require("../../misc/schemaConverter");
var Flexilite;
(function (Flexilite) {
    var SQLite;
    (function (SQLite) {
        ...
        var Driver = (function () {
             ...
             */
            Driver.prototype.getCollectionDefByName = function (className, createIfNotExist, loadProperties) {
                var self = this;
             ...
             */
            Driver.prototype.registerAttribute = function (attrName, pluralName) {
                var self = this;
             ...
             */
            Driver.prototype.registerClassByObject = function (className, data, saveData) {
                ...
                try {
                    ...
                    var classID = this.registerAttribute(className);
             ...
             */
            Driver.prototype.syncModelToSchema = function (model) {
                var self = this;
                // TODO
                // Normalize model
                ...
                if (!existingSchema) {
                    // create new one
                    var sql = "insert into [.schemas] into () values ();";
            ...
            Driver.prototype.sync = function (opts, callback) {
                ...
                Sync(function () {
                    try {
                        ...
                        var collectionDef = self.syncModelToSchema(opts);
                        ...
                        for (var propName in collectionDef.Properties) {
                            if (propIdx > 0)
                                viewSQL += ', ';
                            propIdx++;
                            var p = collectionDef.Properties[propName];
                            if (p.ColumnAssigned) 
                        ...
                        viewSQL += self.generateTriggerBegin(collectionDef.DBViewName, 'insert', 'whenNull', 'when new.[ObjectID] is null or new.[HostID] is null');
                        // Generate new ID
                        ...
                        viewSQL += self.generateTriggerBegin(collectionDef.DBViewName, 'insert', 'whenNotNull', 'when not (new.[ObjectID] is null or new.[HostID] is null)');
