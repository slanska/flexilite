...
var SchemaHelper = (function () {
    ...
    SchemaHelper.nodeOrmTypeToFlexiliteType = function (ormType) {
        ...
        switch (ormType.toLowerCase()) {
            case 'serial':
            case 'integer':
                return 1 /* PROP_TYPE_INTEGER */;
            case 'number':
                return 3 /* PROP_TYPE_NUMBER */;
            case 'binary':
                return 7 /* PROP_TYPE_BINARY */;
            case 'text':
                return 0 /* PROP_TYPE_TEXT */;
            case 'boolean':
                return 4 /* PROP_TYPE_BOOLEAN */;
            case 'object':
                return 11 /* PROP_TYPE_JSON */;
            case 'date':
                return 9 /* PROP_TYPE_DATETIME */;
            case 'enum':
                return 6 /* PROP_TYPE_ENUM */;
            default:
    ...
    SchemaHelper.prototype.convertProperty = function (item, propName, itemKind) {
        ...
        switch (itemKind) {
            ...
            case 'hasOne':
                // Generate relation
                cProp.rules.type = 5 /* PROP_TYPE_OBJECT */;
