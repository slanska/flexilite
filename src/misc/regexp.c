...
static unsigned re_next_char(ReInput *p)
{
    ...
    if (c >= 0x80)
    {
        if ((c & 0xe0) == 0xc0 && p->i < p->mx && (p->z[p->i] & 0xc0) == 0x80)
        {
            ...
            if ((c & 0xf0) == 0xe0 && p->i + 1 < p->mx && (p->z[p->i] & 0xc0) == 0x80
                && (p->z[p->i + 1] & 0xc0) == 0x80)
            {
                ...
                if ((c & 0xf8) == 0xf0 && p->i + 3 < p->mx && (p->z[p->i] & 0xc0) == 0x80
...
{
    return (unsigned char)(p->sIn.i < p->sIn.mx ? p->sIn.z[p->sIn.i] : 0);
}
